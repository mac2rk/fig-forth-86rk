	TITLE	'FIG-FORTH 1.1 RADIO-86RK'
	.8080
	ASEG
; Radio-86RK: load at 0100H, start with G100; warm entry G104.
; Standard 32K Monitor required; EM is 7600H.
; Address labels use colons; EQU symbols do not. See RADIO86.md.
;
...
;	MEMORY ALLOCATION
;
EM	EQU	7600H	; EXCLUSIVE LIMIT; MONITOR/VIDEO AT 7600H..7FFFH
...
PTSTO:	DW	$+2
	...
	PAGE
;--------------------------------------------------
; Diskless compatibility variables and buffer storage.
BPS	EQU	128
;
...
ARROW:	DW	NODISK
;
; Radio-86RK Monitor console interface. All calls preserve BC (Forth IP).
MONRET EQU 0F800H
MONKEY EQU 0F803H
MONOUT EQU 0F809H
MONSTA EQU 0F812H
EPRINT: DW 0 ; Reserved compatibility cell; no printer installed.
;
CSTAT: PUSH B
 PUSH D
 PUSH H
...
CPOUT: JMP COUT
;
; Shared code-field target: abandon caller, reset both stacks before printing.
NODISK: LXI SP,INITS0
 LXI H,INITR0
 SHLD RPP
 LXI H,1
 SHLD DSKERR+2
...
;
INITDP:
; Run node check-port.cjs to verify dictionary/stack clearance.
;
	PAGE
;
;		MEMORY MAP
...
MDIO	EQU	DRIVE		  ;DISKLESS COMPATIBILITY
