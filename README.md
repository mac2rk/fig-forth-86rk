...
The source uses Microsoft MACRO-80 (M80) conventions and builds with the included Python assembler, [assemble8080](assemble8080/README.md). Basic functionality has been verified in Emu80 with the Radio-86RK Monitor ROM.
